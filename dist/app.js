...
var _user$project$Models$initialModel = {projects: _krisajenkins$remotedata$RemoteData$Loading};
...
var _user$project$Helpers$projectDecoder = A3(
...
var _user$project$Helpers$projectsDecoder = _elm_lang$core$Json_Decode$list(_user$project$Helpers$projectDecoder);
var _user$project$Helpers$fetchProjectsUrl = 'http://localhost:4000/projects';
var _user$project$Helpers$fetchProjects = A2(
	_elm_lang$core$Platform_Cmd$map,
	_user$project$Msgs$OnFetchProjects,
	_krisajenkins$remotedata$RemoteData$sendRequest(
		A2(_elm_lang$http$Http$get, _user$project$Helpers$fetchProjectsUrl, _user$project$Helpers$projectsDecoder)));
...
var _user$project$Main$init = {ctor: '_Tuple2', _0: _user$project$Models$initialModel, _1: _user$project$Helpers$fetchProjects};
