...
var _user$project$Models$Model = F2(
	function (a, b) {
		return {projects: a, route: b};
	});
var _user$project$Models$Project = F4(
	function (a, b, c, d) {
		return {id: a, name: b, description: c, width: d};
	});
...
var _user$project$Pages_Home$header = A2(
	_elm_lang$html$Html$a,
	{
		ctor: '::',
		_0: _user$project$Pages_Home$id(_user$project$Styles_SharedStyles$FlexHeader),
		_1: {
			ctor: '::',
	...
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Open-source projects'),
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	});
...
var _user$project$Pages_Home$secondaryHeader = function (project) {
	return A2(
		_elm_lang$html$Html$h2,
		{
			ctor: '::',
			_0: _user$project$Pages_Home$id(_user$project$Styles_SharedStyles$FlexSecondaryHeader),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$Pages_Project$projectItem = function (project) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _user$project$Pages_Project$id(_user$project$Styles_SharedStyles$ProjectImage),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('[IMG]'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
					...
					},
					{
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _user$project$Pages_Project$id(_user$project$Styles_SharedStyles$ProjectDescription),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('-> TO GITHUB <-'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
		...
		var carouselView = function () {
			...
			if (_p1.ctor === 'Err') {
				...
				return A2(
					...
					{
						ctor: '::',
						_0: _user$project$Pages_Project$btnPrevious(_p2.previous),
						_1: {
							ctor: '::',
							_0: _user$project$Pages_Project$projectItem(project),
							_1: {
								ctor: '::',
								_0: _user$project$Pages_Project$btnNext(_p2.next),
								_1: {ctor: '[]'}
							}
						}
					});
	...
	function (project, response) {
		...
		switch (_p3.ctor) {
			...
			case 'Loading':
				return _elm_lang$html$Html$text('Loading...');
			case 'Success':
				return A2(_user$project$Pages_Project$form, project, _p3._0);
			default:
				return _elm_lang$html$Html$text(
...
var _user$project$View$page = function (model) {
	...
	switch (_p2.ctor) {
		case 'ProjectsRoute':
			return _user$project$Pages_Home$view(model.projects);
		case 'ProjectRoute':
			return A2(_user$project$View$projectPage, model, _p2._0);
		default:
...
var _user$project$View$footer = A2(
	...
	{ctor: '[]'},
	{ctor: '[]'});
var _user$project$View$_p3 = _user$project$Styles_SharedStyles$styleNamespace;
var _user$project$View$id = _user$project$View$_p3.id;
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$View$id(_user$project$Styles_SharedStyles$BodySection),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$View$id(_user$project$Styles_SharedStyles$FooterSection),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _user$project$Routing_Helpers$fetchProjects = A2(
	...
	_krisajenkins$remotedata$RemoteData$sendRequest(
		A2(_elm_lang$http$Http$get, _user$project$Routing_Helpers$fetchProjectsUrl, _user$project$Routing_Helpers$projectsDecoder)));
