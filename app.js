...
var _user$project$Models$new = {id: '0', name: '', level: 1};
...
var _user$project$Pages_Project$btnLevelIncrease = function (project) {
	return A2(
...
var _user$project$Pages_Project$btnLevelDecrease = function (project) {
	return A2(
		_elm_lang$html$Html$a,
		{
			ctor: '::',
...
var _user$project$Pages_Project$formLevel = function (project) {
	return A2(
						...
						_0: A2(
							...
							},
							{
								...
								_0: _elm_lang$html$Html$text(
									_elm_lang$core$Basics$toString(project.level)),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: _user$project$Pages_Project$btnLevelDecrease(project),
							_1: {
								ctor: '::',
								_0: _user$project$Pages_Project$btnLevelIncrease(project),
								_1: {ctor: '[]'}
							}
						}
					}),
...
var _user$project$Pages_Project$form = function (project) {
	return A2(
		...
		},
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$Pages_Project$formLevel(project),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Pages_Project$nav = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
...
var _user$project$Pages_Project$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Pages_Project$nav(model),
			_1: {
				ctor: '::',
...
var _user$project$Pages_Home$goToProjectBtn = function (project) {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('Go to Project'),
			_1: {ctor: '[]'}
		});
};
var _user$project$Pages_Home$projectRow = function (project) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(project.id),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _user$project$Pages_Home$goToProjectBtn(project),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
				...
				{ctor: '[]'},
				{
					...
					_1: {
						...
						_0: A2(
							...
							{ctor: '[]'},
							A2(_elm_lang$core$List$map, _user$project$Pages_Home$projectRow, projects)),
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
...
var _user$project$Pages_Home$nav = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
...
var _user$project$Pages_Home$view = function (response) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Pages_Home$nav,
			_1: {
				ctor: '::',
